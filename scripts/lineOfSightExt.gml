...
/*Return 5 values:
 - A boolean stating whether the target object intersects with the line defined by x1, y1, x2, and y2
 - The x_pos of the intersection
 - The y_pos of the intersection
 - The x_pos one tick before the intersection
 - The y_pos one tick before the intersection
*/
return_values[4] = pos_x - inc_x * 2;
return_values[3] = pos_x - inc_x * 2;
return_values[2] = pos_y - inc_y;
return_values[1] = pos_x - inc_x;
return_values[0] = sight;
